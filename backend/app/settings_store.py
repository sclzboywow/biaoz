...
DEFAULT_SETTINGS: dict[str, dict[str, str]] = {
    ...
    "ocr_host_concurrency": {
        ...
        "description": "同一下载 host 同时运行的 OCR 任务数上限；0 表示不限流。",
    },
    "ocr_source_hourly_limit": {
        "value": "0",
        "value_type": "int",
        "label": "OCR 单来源每小时上限",
        "description": "同一 trusted source 每小时最多启动的 OCR 任务数；0 表示不限流。",
    },
    ...
    "ocr_task_stale_seconds": {
        "value": "900",
        "value_type": "int",
        "label": "OCR 任务僵死释放秒数",
        "description": "RUNNING 状态超过该秒数未结束时自动释放锁并回到 PENDING 或转人工。",
    },
    "post_decision_ingest_enabled": {
        "value": "true",
        "value_type": "bool",
        "label": "决策通过后自动采集",
        "description": "治理决策 AUTO_CONFIRMED/AUTO_MERGED 后，按来源通道立即触发一次文件入库。",
    },
    "post_decision_ingest_limit": {
        "value": "50",
        "value_type": "int",
        "label": "决策后采集批次上限",
...
def ensure_default_trusted_sources(db: Session) -> None:
    defaults = [
        ...
        # --- 第二批：工程和行业增强源（默认关闭，验证后手动启用）---
        {
            "source_name": "交通运输标准化信息系统",
            "base_url": "https://jtst.mot.gov.cn",
            "trust_level": "A",
            "trust_score": 100,
            "source_type": "交通运输标准权威信息源",
            "adapter_key": "mot_transport_standard_public",
            "capabilities": "list,detail,status,change",
            "is_status_authority": True,
            "crawl_mode": "公开标准列表 + 详情页",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批工程增强源：JT/JTG 交通标准；默认关闭。",
        },
        {
            "source_name": "水利部水利技术标准查询系统",
            "base_url": "http://gjkj.mwr.gov.cn/jsjd1/bzh/bzhfbgg/index.htm",
            "trust_level": "A",
            "trust_score": 100,
            "source_type": "水利技术标准权威信息源",
            "adapter_key": "mwr_water_standard_public",
            "capabilities": "list,detail,status,change",
            "is_status_authority": True,
            "crawl_mode": "公开标准发布列表 + 详情页",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批工程增强源：SL/SL/T 水利标准；默认关闭。",
        },
        {
            "source_name": "认证认可标准化信息服务平台",
            "base_url": "https://rbtest.cnca.cn/portal/xxcx/std",
            "trust_level": "A",
            "trust_score": 95,
            "source_type": "认证认可标准信息源",
            "adapter_key": "cnca_rb_standard_public",
            "capabilities": "list,detail,status,change",
            "is_status_authority": True,
            "crawl_mode": "RB/T 标准公开查询",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批增强源：RB/T 认证认可标准；默认关闭。",
        },
        {
            "source_name": "工业和信息化标准信息服务平台",
            "base_url": "https://std.miit.gov.cn",
            "trust_level": "A",
            "trust_score": 90,
            "source_type": "工业和信息化标准增强信息源",
            "adapter_key": "miit_standard_public",
            "capabilities": "list,announcement,change,comment_period",
            "is_status_authority": False,
            "crawl_mode": "标准计划/公示/报批/复审公告索引",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批增强源：补计划公示，不全量重复正文；默认关闭。",
        },
        {
            "source_name": "国家能源局能源标准",
            "base_url": "https://www.nea.gov.cn/ztzl/nybz/bzgl/index.htm",
            "trust_level": "A",
            "trust_score": 90,
            "source_type": "能源标准公告信息源",
            "adapter_key": "nea_energy_announcement_public",
            "capabilities": "list,announcement,change,comment_period",
            "is_status_authority": True,
            "crawl_mode": "标准计划/目录/废止/征求意见公告",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批增强源：NB/DL 公告索引，不抓正文；默认关闭。",
        },
        {
            "source_name": "自然资源标准化信息服务平台",
            "base_url": "https://www.nrsis.org.cn/",
            "trust_level": "A",
            "trust_score": 95,
            "source_type": "自然资源标准信息源",
            "adapter_key": "nrs_natural_resource_standard_public",
            "capabilities": "list,detail,status,change,comment_period",
            "is_status_authority": True,
            "crawl_mode": "标准公开/制修订/征求意见列表",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批增强源：TD/CH 自然资源标准；默认关闭。",
        },
        {
            "source_name": "国家消防救援局",
            ...
            "trust_level": "B+",
            "trust_score": 85,
            "source_type": "消防政策公告增强源",
            "adapter_key": "mem_fire_rescue_announcement_public",
            "capabilities": "list,announcement,change,comment_period",
            "is_status_authority": True,
            "crawl_mode": "政策法规/通知公告/征求意见",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批增强源：消防政策与征求意见；默认关闭。",
        },
        {
            "source_name": "应急管理部",
            ...
            "trust_level": "B+",
            "trust_score": 85,
            "source_type": "应急管理政策公告增强源",
            "adapter_key": "mem_emergency_announcement_public",
            "capabilities": "list,announcement,change,comment_period",
            "is_status_authority": True,
            "crawl_mode": "安全生产/危化/标准征求意见公告",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批增强源：AQ/YJ 政策与征求意见；默认关闭。",
        },
        {
            "source_name": "全国认证认可信息公共服务平台",
            "base_url": "https://cx.cnca.cn/",
            "trust_level": "A",
            "trust_score": 90,
            "source_type": "认证认可资质证书信息源",
            "adapter_key": "cnca_certification_portal_public",
            "capabilities": "list,certification,org",
            "is_status_authority": False,
            "crawl_mode": "认证结果/检验检测/资质证书公开索引",
            "crawl_frequency": "weekly",
            "enabled": False,
            "remark": "第二批增强源：资质证书数据写入 certification_records；默认关闭。",
        },
    ]
    changed = False
