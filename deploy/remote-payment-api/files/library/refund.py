"""Ticket order refund: Alipay refund + revoke download tickets."""
...
def refund_ticket_order(
    ...
    *,
    ...
    """Refund a paid ticket order via Alipay and deduct granted tickets."""
    ...
    _order_id, user_id, group_id, ticket_count, amount_cent, status, alipay_trade_no = row
    if status == "refunded":
    ...
    pay_result = refund_alipay_trade(
        ...
        refund_reason=reason or "refund",
    )
